...
def entropie():
    tentatives_possibles=["motus","other","fangs","dimes"]
    for i in range(len(tentatives_possibles)):
        mot_possible = split(tentatives_possibles[i])
        for a in range(len(mot_possible)):
            lettre_testee = mot_possible[a]
