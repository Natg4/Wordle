...
class wordle:
    def __init__(self):
         self.possible=list(possible_words)
         self.autorise=list(allowed_words)
         self.mot=random.choice(possible_words)
         self.grey=[]
         self.green=[0]*5
    ...
    def iaelab(self):
        ...
        while essai != self.mot :
                ...
                if self.compteur==1:
                    ...
                    self.essai(essai)
                    print(essai)
                    if self.green != self.mot:
                        self.tri(essai)
                    else:
                        print("Mot :",self.mot," trouvé en ",self.compteur)
                else:
                    essai=es.info_maximale(self.possible,self.possible,self.possible)
                    self.essai(essai)
                    print(essai)
                    if essai != self.mot:
